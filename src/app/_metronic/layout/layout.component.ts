...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.router.events.subscribe((event) => {
     ...
     this.toastr.success('hellow, world','-toast fun!');
     this.toastr.error('hellow, world','-toast fun!');
     this.toastr.warning('hellow, world','-toast fun!');
     this.toastr.info('hellow, world','-toast fun!');
  }
